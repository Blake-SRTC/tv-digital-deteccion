...
def tab3(root, common_img, bits_n, bits_p):
    ...
    comprobar = Button(pagina3, text='Comprobar',font=('Times_New_Roman',20, BOLD), image=common_img, compound='c', width=200, height=50, command=lambda: comprobar_polinomio(entry1))
    comprobar.place(x=750, y=175)
    # ESTADO DE LA COMPROBACION
    lbl4_estado = Label(pagina3, text='ESTADO',font=('Times_New_Roman',20, BOLD), image=common_img, compound='c', width=100,height=50, bg='gray')

...
def tab2(root, common_img, bits_n, bits_p):
    ...
    lbl2_bits_normales = Label(pagina1, text='Bits: ',font=('Times_New_Roman',20, BOLD), image=common_img, compound='c', height=50)
    lbl2_bits_normales.place(x=100, y=100)
    lbl2_bits_codificados = Label(pagina1, text='LRC: ',font=('Times_New_Roman',20, BOLD), image=common_img, compound='c', height=50)
    ...
    # BOTON DE TRANSMITIR
    btn2_transmitir = Button(pagina1, text='Transmitir', font=('Times_New_Roman',20, BOLD), command=transmitir,image=common_img, compound='c', height=50, width=200)
